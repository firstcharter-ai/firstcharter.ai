      ...
      .then(function (res) {
        if (res.ok) {
          ...
          return res.json().catch(function () { return {}; }).then(function (body) {
            setStatus(body.error || 'Something went wrong. Please email shea@firstcharter.ai instead.', 'err');
          });
        }
      })
      .catch(function () {
        setStatus('Network error. Please try again, or email shea@firstcharter.ai.', 'err');
      })
      .finally(function () {
